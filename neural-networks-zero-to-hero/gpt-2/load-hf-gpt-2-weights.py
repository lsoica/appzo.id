...
model.to(mps_device)
import datetime
print(f"Model on MPS at {datetime.datetime.now()}")

import tiktoken
enc = tiktoken.get_encoding('gpt2')
tokens = enc.encode("Hello, I'm a language model,") # translates to 8 tokens
...
print(f"Completions ready at {datetime.datetime.now()}")
